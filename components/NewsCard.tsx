...
export function NewsCard({ item }: Props) {
  return (
    ...
    >
      <Link
        href={`/news/${item.slug}`}
        className="group flex touch-manipulation flex-col rounded-2xl border border-zinc-200/90 bg-white/95 p-4 shadow-md ring-1 ring-zinc-950/5 transition active:scale-[0.99] dark:border-zinc-700 dark:bg-zinc-900/95 dark:shadow-none dark:ring-0 sm:p-5 @md:p-6 @md:hover:border-zinc-300 @md:hover:shadow-lg @md:hover:ring-zinc-950/10 dark:@md:hover:border-zinc-600 dark:@md:hover:bg-zinc-800/90"
      >
